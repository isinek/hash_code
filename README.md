...
- the first line contains:
  ...
  - an integer $D_i$ (1 ≤ $D_i$ ≤ $10^5$) – the number of days it takes to complete the project,
  - an integer $S_i$ (1 ≤ $S_i$ ≤ $10^5$) – the score awarded for project’s completion,
  - an integer $B_i$ (1 ≤ $B_i$ ≤ $10^5$) – the “best before” day for the project,
  - an integer $R_i$ (1 ≤ $R_i$ ≤ $10^5$) – the number of roles in the project.
- the next $R_i$ lines describe the skills in the project:
